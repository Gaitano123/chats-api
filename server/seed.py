...
with app.app_context():
    ...
    for _ in range(0, 200):
        group = Group(
            ...
            profile = 'https://cdn-icons-png.flaticon.com/512/268/268547.png',
